...
const Gallery = () => {
  const cardDetails = [
    {
      title: "deep earth",
      img: "bg-img0-sm xl:bg-img0-xl",
    },
    {
      title: "night arcade",
      img: "bg-img1-sm xl:bg-img1-xl",
    },
    {
      title: "soccer team vr",
      img: "bg-img2-sm xl:bg-img3-xl",
    },
    {
      title: "the grid",
      img: "bg-img3-sm xl:bg-img3-xl",
    },
    {
      title: "from up above vr",
      img: "bg-img4-sm xl:bg-img4-xl",
    },
    {
      title: "pocket porealis",
      img: "bg-img5-sm xl:bg-img5-xl",
    },
    {
      title: "the curiosity",
      img: "bg-img6-sm xl:bg-img6-xl",
    },
    {
      title: "make it fisheye",
      img: "bg-img7-sm xl:bg-img7-xl",
    },
  ];
